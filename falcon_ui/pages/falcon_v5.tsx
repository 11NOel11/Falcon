...
export default function FalconV5() {
  ...
  const getOptimizerColor = (optimizer: string) => {
    ...
    if (optimizer === 'FALCON v5') return '#00F5FF';
    return '#888';
  };
  ...
  return (
    <>
      <Head>
        <title>Falcon V5 - Experimental Results</title>
        <meta name="description" content="Complete experimental results and figures from Falcon V5 research" />
      </Head>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="mb-12 text-center">
            <h1 className="text-5xl font-display font-bold text-white mb-4">
              FALCON v5 Experimental Results
            </h1>
          ...
          <div className="mb-12 p-8 bg-gradient-to-br from-falcon-card to-falcon-bg border border-falcon-blue/30 rounded-lg">
            <h2 className="text-2xl font-bold text-falcon-cyan mb-4">Key Findings</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                <h3 className="text-lg font-bold text-falcon-blue mb-2">Competitive Accuracy</h3>
                <p className="text-gray-300 text-sm">
                  Falcon achieves <strong>90.33%</strong> on CIFAR-10 with VGG11,
                  comparable to AdamW (90.28%) and Muon (90.49%)
                </p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-falcon-pink mb-2">Computational Cost</h3>
                <p className="text-gray-300 text-sm">
                  40% slower than AdamW due to FFT operations and rank-1 approximations
                  (6.7s vs 4.8s per epoch)
                </p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-falcon-cyan mb-2">Data Efficiency</h3>
                <p className="text-gray-300 text-sm">
                  No significant advantage with limited data (10% or 20%),
                  suggesting frequency filtering benefits full-scale training
                </p>
              </div>
            </div>
          </div>
